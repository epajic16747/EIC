	...
	<div class="main">
      ...
      <div id="popupWindowID" class="popupWindow">
	      <div class="popupWindowContent">
            ...
            if(isset($_SESSION['username']))
	            {      
	                print '<br><p>Download: <a href="pages/downloadAllEventsCSV.php">All events as CSV file</a></p>';
	                print '<br><p>Download: <a href="pages/downloadAllEventsFullInfoPDF.php">Full events info as PDF file</a></p>';
	            }
            ?>
